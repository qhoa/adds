...
Register-ScheduledJob -Name ResumeWorkflow -Trigger $AtStartup -ScriptBlock {Import-Module PSWorkflow; Get-Job ADJob -State Suspended | Resume-Job}
...
workflow ADSetup {
  Set-Static-IP
  Rename-Computer -NewName DC -Force -Passthru
